...
export interface StudentResonance {
  likes: Array<StudentResonanceLike>;
  dislikes: Array<StudentResonanceLike>;
}

type StudentResonanceKeys = 'name' | 'surname';
export type StudentResonanceLike = Pick<Student, StudentResonanceKeys> & {
  date: Date;
};
